/**
 * @file messagingHistoryTypes.ts
 * @path KaibanJS/src/types/llm/message/messagingHistoryTypes.ts
 * @description Type definitions for message history management and configuration
 * 
...
export interface IMessageHistoryConfig {
    maxMessages?: number;
    maxTokens?: number;
...
export interface IMessageHistoryState {
...
export interface IMessageHistoryMetrics {
    messageCount: number;
    tokenCount: number;
